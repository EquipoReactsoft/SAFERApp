package com.reactsoft.safer.data.locator;

import com.reactsoft.safer.domain.repository.RepositoryLocator;
import com.reactsoft.safer.data.repository.comment.CommentDataRepository;
import com.reactsoft.safer.data.repository.comment.CommentDataSource;
import com.reactsoft.safer.data.repository.comment.FakeCommentDataSource;
import com.reactsoft.safer.data.repository.like.FakeLikeDataSource;
import com.reactsoft.safer.data.repository.like.LikeDataRepository;
import com.reactsoft.safer.data.repository.like.LikeDataSource;
import com.reactsoft.safer.data.repository.loggedUser.AuthenticatedUserDataRepository;
import com.reactsoft.safer.data.repository.loggedUser.FakeLoggedUserDataSource;
import com.reactsoft.safer.data.repository.loggedUser.LoggedUserDataSource;
import com.reactsoft.safer.data.repository.photo.FakePhotoDataSource;
import com.reactsoft.safer.data.repository.photo.PhotoDataRepository;
import com.reactsoft.safer.data.repository.photo.PhotoDataSource;
import com.reactsoft.safer.data.repository.user.FakeUserDataSource;
import com.reactsoft.safer.data.repository.user.UserDataRepository;
import com.reactsoft.safer.data.repository.user.UserDataSource;
