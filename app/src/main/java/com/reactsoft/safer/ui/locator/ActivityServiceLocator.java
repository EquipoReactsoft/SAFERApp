...
import com.reactsoft.safer.data.locator.DataServiceLocator;
...
import com.reactsoft.safer.domain.interactors.GetPhoto;
import com.reactsoft.safer.domain.interactors.GetPhotoComments;
import com.reactsoft.safer.domain.interactors.GetPhotoLikes;
import com.reactsoft.safer.domain.interactors.GetPhotos;
import com.reactsoft.safer.domain.interactors.GetUser;
import com.reactsoft.safer.domain.interactors.InteractorLocator;
import com.reactsoft.safer.domain.interactors.LikePhoto;
import com.reactsoft.safer.domain.interactors.PublishComment;
import com.reactsoft.safer.domain.interactors.PublishPhoto;
import com.reactsoft.safer.domain.interactors.UpdateUser;
import com.reactsoft.safer.domain.interactors.UploadPhoto;
import com.reactsoft.safer.domain.repository.RepositoryLocator;
import com.reactsoft.safer.ui.activity.comments.CommentsPresenter;
import com.reactsoft.safer.ui.activity.comments.CommentsPresenterLocator;
import com.reactsoft.safer.ui.activity.main.MainPresenter;
import com.reactsoft.safer.ui.activity.main.MainPresenterLocator;
import com.reactsoft.safer.ui.activity.publish.PublishPresenter;
import com.reactsoft.safer.ui.activity.publish.PublishPresenterLocator;
import com.reactsoft.safer.ui.orchestrator.GetCommentItem;
import com.reactsoft.safer.ui.orchestrator.GetCommentItems;
import com.reactsoft.safer.ui.orchestrator.GetFeedItem;
import com.reactsoft.safer.ui.orchestrator.GetFeedItems;
import com.reactsoft.safer.ui.orchestrator.OrchestratorLocator;
